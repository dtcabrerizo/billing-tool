    ...
    "services": [
        {
            ...
            "group": "network",
            "steps": [
                { "type": "filter", "field": "NomeDoMedidor (MeterName)", "operator": "regexp", "value": /(Basic Gateway|VpnGw*)/ }
            ...
            "steps": [
                { "type": "filter", "field": "SubcategoriaDoMedidor (MeterSubCategory)", "operator": "ct", "value": "Compute" }                
            ], "reference": 720, "increment": 5
        }, {
